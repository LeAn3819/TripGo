const Sub = () => {
  return (
    <div className="relative mt-[45px] w-4/5  mx-auto h-[400px] bg-[#E7F0F8]  rounded-tl-[129px] rounded-bl-[20px] rounded-tr-[20px] rounded-br-[20px] flex flex-col justify-center items-center">
      <div className="absolute bg-[#747DEF] w-[70px] h-[70px] rounded-full text-white text-[36px] flex justify-center items-center right-[-10px] top-[-10px]"></div>
      ...
      <div className="flex justify-center items-center space-x-4">
        ...
        <button className="h-16 w-40 bg-customBlue text-white font-bold rounded-lg bg-blue-400  hover:bg-blue-700 transition">
          Đăng ký
        </button>
      </div>
    </div>
